...
const CHALLENGE_DOCS: ChallengeDoc[] = [
  ...
  },
  {
    ...
    trackingLogic: 'Checked against users.total_trades >= 1',
  ...
  },
  {
    ...
    category: 'wildcard',
    xp: 100,
    description: 'Create two orders with the same sell token and buy tokens',
    eventType: 'order_created',
    trackingLogic: 'On order_created: queries all previous order_created events for this user. Checks if any prior event has the same sell_token and buy_tokens (JSON). If a match exists, challenge is completed.',
    eventData: ['sell_token', 'buy_tokens'],
    status: 'implemented',
  },
  ...
  },
  {
    ...
    category: 'wildcard',
    xp: 3000,
    description: 'Have a single order filled by 2 different wallets',
    eventType: 'trade_completed',
    trackingLogic: 'On trade_completed where is_maker === true: queries all trade_completed events for the same order_id and extracts unique filler_wallet addresses. Completes when any single order has >= 2 unique fillers.',
  ...
  },
  {
    ...
    category: 'wildcard',
    xp: 500,
    description: 'Cancel 10 orders in one day',
    eventType: 'order_cancelled',
    trackingLogic: 'Count order_cancelled events for user within current UTC day >= 10',
    eventData: ['order_id'],
    status: 'implemented',
  },
