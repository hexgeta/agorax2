            ...
            <div className="pt-12 md:pt-20 pb-16 px-4 md:px-6">
              ...
              >
                ...
                <div className="space-y-3 max-w-3xl mx-auto">
                  ...
                  <FAQItem
                    ...
                    answer="<strong class='text-white'>Fundamentally different architectures:</strong><br/><br/><strong class='text-green-400'>AgoráX (Limit Order Book):</strong><br/>• <strong>Zero slippage</strong> - You set exact prices, trade executes at that price or not at all<br/>• <strong>One order, 50 tokens</strong> - Accept payment in up to 50 different tokens simultaneously<br/>• <strong>No impermanent loss</strong> - You're a trader, not a liquidity provider<br/>• <strong>Non-transferable receipts</strong> - AGX tokens can't be transferred, sold, or stolen via phishing<br/>• <strong>Rug-pull resistant</strong> - Per-order accounting means your tokens are isolated in YOUR order, not commingled in a shared pool<br/>• <strong>MEV protection</strong> - Built-in cooldown period prevents sandwich attacks and flash loan exploits<br/><br/><strong class='text-red-400'>Uniswap V3 (AMM):</strong><br/>• Slippage on every trade - price worsens as trade size increases<br/>• Single token pairs only - one LP position = one pair<br/>• Impermanent loss risk - you lose value when prices move<br/>• LP positions are NFTs - transferable, sellable, and vulnerable to theft<br/>• Commingled liquidity pools - one exploit can drain everyone's funds<br/>• MEV vulnerable - sandwich attacks are common"
              ...
              >
                ...
                <div className="flex justify-center">
                  <ConnectButton connectedText="Create an Order" connectedHref="/trade" />
                </div>
              </motion.section>
