...
export default function StatsClient({ dbOrders, dbFills }: StatsClientProps) {
  ...
  const dataReady = hasPrices || !pricesLoading;
            ...
            {!dataReady ? (
              ...
              >
                ...
                <p className="text-gray-400 text-sm">
                  {pricesLoading ? 'Fetching token prices...' : 'Finalizing...'}
                </p>
              </motion.div>
            ) : !hasData ? (
              <motion.div
