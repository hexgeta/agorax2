...
const getStatusColor = (order: any) => {
  ...
  switch (status) {
    ...
    default: return 'text-[rgba(255, 255, 255, 1)]/60';
  }
};
...
export default function OrderHistoryTable({
  ...
  return (
    <div className="w-full min-w-[800px] text-lg">
      {/* Table Header */}
      <div className="grid grid-cols-[minmax(120px,1fr)_minmax(120px,1fr)_minmax(80px,120px)_minmax(100px,140px)_minmax(100px,140px)_minmax(80px,120px)_minmax(80px,120px)_minmax(80px,120px)_auto] items-center gap-4 pb-4 border-b border-[rgba(255, 255, 255, 1)]/30">
        {/* COLUMN 1: You Bought */}
        <button
          onClick={() => handleSort('sellAmount')}
          className={`text-sm font-medium text-left hover:text-[rgba(255, 255, 255, 1)] transition-colors ${sortField === 'sellAmount' ? 'text-[rgba(255, 255, 255, 1)]' : 'text-[rgba(255, 255, 255, 1)]/60'
            }`}
        >
        ...
        <button
          ...
          className={`text-sm font-medium text-left hover:text-[rgba(255, 255, 255, 1)] transition-colors ${sortField === 'askingFor' ? 'text-[rgba(255, 255, 255, 1)]' : 'text-[rgba(255, 255, 255, 1)]/60'
            }`}
        >
        ...
        <button
          ...
          className={`text-sm font-medium text-center hover:text-[rgba(255, 255, 255, 1)] transition-colors ${sortField === 'progress' ? 'text-[rgba(255, 255, 255, 1)]' : 'text-[rgba(255, 255, 255, 1)]/60'
            }`}
        >
        ...
        <button
          ...
          className={`text-sm font-medium text-center hover:text-[rgba(255, 255, 255, 1)] transition-colors ${sortField === 'otcVsMarket' ? 'text-[rgba(255, 255, 255, 1)]' : 'text-[rgba(255, 255, 255, 1)]/60'
            }`}
        >
        ...
        <button
          ...
          className={`text-sm font-medium text-center hover:text-[rgba(255, 255, 255, 1)] transition-colors ${sortField === 'date' ? 'text-[rgba(255, 255, 255, 1)]' : 'text-[rgba(255, 255, 255, 1)]/60'
            }`}
        >
        ...
        {displayRows.map(({ transaction, baseOrder }) => {
          ...
          return (
            <div
              ...
              className={`grid grid-cols-[minmax(120px,1fr)_minmax(120px,1fr)_minmax(80px,120px)_minmax(100px,140px)_minmax(100px,140px)_minmax(80px,120px)_minmax(80px,120px)_minmax(80px,120px)_auto] items-start gap-4 py-8 ${displayRows.indexOf(displayRows.find(r => r.transaction.transactionHash === transaction.transactionHash)!) < displayRows.length - 1 ? 'border-b border-[rgba(255, 255, 255, 1)]/20' : ''
                }`}
            >
              ...
              <div className="flex flex-col items-start space-y-1 min-w-0 overflow-hidden">
                <div className="inline-block">
                  {isSellTransaction ? (
                    ...
                    <>
                      <span className={`text-lg font-medium ${originalMinBuyAmountUSD > 0 ? 'text-[rgba(255, 255, 255, 1)]' : 'text-gray-500'}`}>
                        {originalMinBuyAmountUSD > 0 ? formatUSD(originalMinBuyAmountUSD) : '--'}
                      </span>
                      <div className="w-1/2 h-px bg-[rgba(255, 255, 255, 1)]/10 my-2"></div>
                          ...
                          return (
                            <div key={buyTokenInfo.address} className="flex items-center space-x-2 mb-3">
                              ...
                              <div className="flex flex-col">
                                <span className="text-[rgba(255, 255, 255, 1)] text-sm font-medium whitespace-nowrap">
                                  {formatTokenTicker(buyTokenInfo.ticker)}
                                </span>
                                <span className="text-[rgba(255, 255, 255, 1)]/60 text-xs whitespace-nowrap">
                    ...
                    <>
                      <span className={`text-lg font-medium ${sellPrice > 0 ? 'text-[rgba(255, 255, 255, 1)]' : 'text-gray-500'}`}>
              ...
              <div className="flex flex-col items-center space-y-2 mt-0.5 min-w-0">
                <span className={`text-xs ${fillPercentage === 0 ? 'text-gray-500' : 'text-[rgba(255, 255, 255, 1)]'}`}>
                ...
                <div className="w-[60px] h-1 bg-gray-500 rounded-full overflow-hidden relative">
                  ...
                  <div
                    className={`h-full rounded-full transition-all duration-300 ${fillPercentage === 0 ? 'bg-gray-500' : 'bg-blue-500'
                      }`}
                    style={{
                  ...
                  {userSharePercentage > 0 && (
                    <div
                      className={`absolute top-0 left-0 h-full rounded-full transition-all duration-300 ${isSellTransaction ? 'bg-red-500' : 'bg-green-500'
                        }`}
                      style={{
              ...
              <div className="text-center min-w-0">
                <div className="text-sm">
                  {otcPercentage !== null ? (
                    <span className={`font-medium ${otcPercentage < 0
                ...
                {otcPercentage !== null && (
                  <div className="text-xs text-[rgba(255, 255, 255, 1)]/60 mt-0">
                  ...
                  {backingPriceDiscount !== null ? (
                    <>
                      {(PAYWALL_ENABLED && !hasTokenAccess) ? (
                        ...
                        >
                          <Lock className="w-5 h-5 -mt-1 text-[rgba(255, 255, 255, 1)]/60 hover:text-[rgba(255, 255, 255, 1)]" />
                        </button>
                      ) : (
                        <span className={`font-medium ${isAboveBackingPrice
                            ? 'text-[rgba(255, 255, 255, 1)]/60'    // Neutral - selling above backing price
              ...
              <div className="text-center min-w-0 mt-1">
                <div className="flex flex-col items-center gap-2">
                  <span className={`px-3 py-1 rounded-full text-sm font-medium border w-[110px] ${isSellTransaction
                      ? 'bg-red-500/20 text-red-400 border-red-400'
                      : 'bg-green-500/20 text-green-400 border-green-400'
                    }`}>
                    {isSellTransaction ? 'Sell' : 'Buy'}
                  </span>
                  <span className={`px-3 py-1 rounded-full text-sm font-medium border w-[110px] ${getStatusText(baseOrder) === 'Expired'
              ...
              <div className="text-center min-w-0 mt-0.5">
                {transaction.timestamp ? (
                  <div className="flex flex-col items-center">
                    <span className="text-[rgba(255, 255, 255, 1)] text-sm font-medium">
                      {formatTimestamp(transaction.timestamp).date}
                    </span>
                    <span className="text-[rgba(255, 255, 255, 1)]/60 text-xs">
                      {formatTimestamp(transaction.timestamp).time}
                    </span>
                  </div>
                ) : (
                  <span className="text-[rgba(255, 255, 255, 1)]/60 text-sm">--</span>
                )}
              </div>
                ...
                <div className="flex flex-col items-center gap-1">
                  ...
                  {transaction?.transactionHash && (
                    <button
                      ...
                      className="px-3 py-2 mt-1 font-medium bg-transparent text-[rgba(255, 255, 255, 1)] text-xs rounded-full border border-white hover:bg-[rgba(255, 255, 255, 1)]/10 hover:text-[rgba(255, 255, 255, 1)] transition-colors"
      ...
      {/* Note about pricing */}
      <div className="mt-6 text-center text-sm text-[rgba(255, 255, 255, 1)]/60">
