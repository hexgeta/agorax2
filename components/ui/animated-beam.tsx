  ...
  return (
    ...
    >
      <path
        ...
        strokeLinecap="round"
        strokeDasharray={dotted ? dotSpacing : undefined}
      />
      <path
        d={pathD}
        strokeWidth={pathWidth}
  ...
  ({ className, children }, ref) => {
    return (
      <div
        ref={ref}
        className={cn(
          'z-10 flex h-12 w-12 items-center justify-center rounded-full border-2 border-white/20 bg-black/50 backdrop-blur-sm',
          className
        )}
      >
        {children}
